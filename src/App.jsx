...
function App() {
  ...
  return (
    ...
    <div className="grid grid-cols-4 grid-rows-[3fr_1fr_2fr] gap-4 h-full w-full">
      {/* Zone principale (grosse zone à gauche) */}
      <div className="col-span-3 row-span-3 bg-[url('background_click.png')] bg-cover bg-center h-full border-2 rounded-md p-5 flex flex-col items-center justify-center">
